...
+----+------------+-------------------------------------------+---------------------------------------------------------------------+
| 9  | PM10freq   | 한국기준 PM10 >  80 (나쁨, 매우나쁨)인    | Day counts of PM10 > 80 (unhealthy and very unhealthy in the Korean |
|    |            |   날수                                    |   Standard)                                                         |
+----+------------+-------------------------------------------+---------------------------------------------------------------------+
| 10 | PM10freqUS | 미국기준 PM10 >  154 (민감군 나쁨, 나쁨,  | Day counts of PM10 > 154 (S-groups unhealthy, unhealthy and very    |
|    |            |   매우나쁨)인 날수                        |   unhealthy in the US Standard)                                     |
+----+------------+-------------------------------------------+---------------------------------------------------------------------+
...
+----+------------+-------------------------------------------+---------------------------------------------------------------------+
| 13 | PM10hrs    | 한국기준 PM10 > 80  (매우 나쁨) 노출시간  | Length of hours with PM10 > 80 ( very unhealthy in the Korean       |
|    |            |                                           |   Standard)                                                         |
+----+------------+-------------------------------------------+---------------------------------------------------------------------+
| 14 | avghrs     | 한국기준 PM10 > 80  (매우 나쁨) 일간 평균 | Daily average exposure hours with PM10 > 80 ( very unhealthy in the |
|    |            |   노출시간                                |   Korean Standard)                                                  |
+----+------------+-------------------------------------------+---------------------------------------------------------------------+
